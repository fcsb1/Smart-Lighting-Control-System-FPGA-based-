...
HD_PWD='C:/Users/Mihai/Documents/Proiect_SSC/Proiect_SSC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_control_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_control_system.tcl -notrace
