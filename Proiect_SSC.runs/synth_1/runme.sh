...
HD_PWD='C:/Users/Mihai/Documents/Proiect_SSC/Proiect_SSC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_control_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_control_system.tcl
